...
#+BEGIN_SRC emacs-lisp :var last-generated=(format-time-string ";; Last generated on %c") :var source-file=(file-name-nondirectory (buffer-file-name))

  ;;; Esprit Emacs --- A literate configuration -*- lexical-binding: t -*-
  ;;; This file has been generated from the source-file file on last-generated. DO NOT EDIT.
